<!-- Generated from CONTRIBUTING.md by scripts/generate_docs.py. Edit the source, not this copy. -->
...
See [docs/GITHUB_WORKFLOW.md](GITHUB_WORKFLOW.md). Short version: branch
